...
///Below is the barebones HTML script for the questions and answers whether they be radio buttons or text boxes etc...
    ...
    <script src="keypress.js"></script>
      ...
      <div class="input-group" id="code_input" method="get" display="none" onsubmit ="return false;">
        ...
        <div class="prolink" id="link" method="get" display="none" onsubmit ="return false;">
       <form id="linkID">
        <p><a href="https://app.prolific.co/submissions/complete?cc=DCD36WR0"> CLICK HERE!:</a></p>
      </form>
      </div>
      ...
      <div class="input-group" id="prol_input" method="get" display="none" onsubmit ="return false;">
        ...
        <div class="input-group" display="none" id="instagram_input" method="get">
          <form id="instagramuser" display="none">
            <span class="slideText">Do you use Instagram?</span><br><br>
...
<div class="input-group" display="none" id="region_input" method="get">
  <form id="regionuser" display="none">
    <span class="slideText">Please select the region in which you are situated.</span><br><br>
    <input type="radio" name="region" value="1"><span class="questionText"> England</span><br>
    <input type="radio" name="region" value="2"><span class="questionText"> Wales </span><br>
    <input type="radio" name="region" value="3"><span class="questionText"> Scotland </span><br>
    <input type="radio" name="region" value="4"><span class="questionText"> Northern Island</span><br>
  </form>
</div>
    ...
    <div class="input-group" id="leeftijdAlter" method="get">
      <form id="leeftijdAltr">
        <input type="radio" name="lA" value="<13" id="lA<13"><label for="lA<13"><span class="questionText"> 13 or under</span></label><br>
        <input type="radio" name="lA" value="14" id="lA14"><label for="lA14"><span class="questionText">  14</span></label><br>
        <input type="radio" name="lA" value="15" id="lA15"><label for="lA15"><span class="questionText">  15</span></label><br>
        <input type="radio" name="lA" value="16" id="lA16"><label for="lA16"><span class="questionText">  16</span></label><br>
        <input type="radio" name="lA" value="17" id="lA17"><label for="lA17"><span class="questionText">  17</span></label><br>
    ...
    <div class="input-group" id="insta1" method="get">
      <span class="slideText">These are some statements regarding your Instagram use, and how often you partake in particular behaviors on Instagram. (If you do not use instagram feel free to skip this question, simply press continue, close the prompt box and press continue once more.):</span><br><br>
      <form id="ins1user" >
        <span class="slideText">Comment or reply to to others posts.</span><br><br>
        <input type="radio" name="in1" value="10"><span class="questionText">  All the time</span><br>
        <input type="radio" name="in1" value="9"><span class="questionText">  Several times an hour</span><br>
        <input type="radio" name="in1" value="8"><span class="questionText">  Once an hour</span><br>
        <input type="radio" name="in1" value="7"><span class="questionText"> Several times a day</span><br>
        <input type="radio" name="in1" value="6"><span class="questionText">  Once a day</span><br>
        <input type="radio" name="in1" value="5"><span class="questionText">  Several times a week</span><br>
        <input type="radio" name="in1" value="4"><span class="questionText">  Once a week</span><br>
        <input type="radio" name="in1" value="3"><span class="questionText">  Several times a month</span><br>
        <input type="radio" name="in1" value="2"><span class="questionText"> Once a month</span><br>
        <input type="radio" name="in1" value="1"><span class="questionText">  Never</span><br>
      </form>
      <form id="ins2user">
        <span class="slideText">Tag others in your posts or comments.</span><br><br>
        <input type="radio" name="in2" value="10"><span class="questionText">  All the time</span><br>
        <input type="radio" name="in2" value="9"><span class="questionText">  Several times an hour</span><br>
        <input type="radio" name="in2" value="8"><span class="questionText">  Once an hour</span><br>
        <input type="radio" name="in2" value="7"><span class="questionText"> Several times a day</span><br>
        <input type="radio" name="in2" value="6"><span class="questionText">  Once a day</span><br>
        <input type="radio" name="in2" value="5"><span class="questionText">  Several times a week</span><br>
        <input type="radio" name="in2" value="4"><span class="questionText">  Once a week</span><br>
        <input type="radio" name="in2" value="3"><span class="questionText">  Several times a month</span><br>
        <input type="radio" name="in2" value="2"><span class="questionText"> Once a month</span><br>
        <input type="radio" name="in2" value="1"><span class="questionText">  Never</span><br>
      </form>
      </form>
    </div>
    ...
    <div class="input-group" id="insta3" method="get">
      ...
      <form id="ins3user" >
        ...
        <input type="radio" name="in3" value="10"><span class="questionText">  All the time</span><br>
        <input type="radio" name="in3" value="9"><span class="questionText">  Several times an hour</span><br>
        <input type="radio" name="in3" value="8"><span class="questionText">  Once an hour</span><br>
        <input type="radio" name="in3" value="7"><span class="questionText"> Several times a day</span><br>
        <input type="radio" name="in3" value="6"><span class="questionText">  Once a day</span><br>
        <input type="radio" name="in3" value="5"><span class="questionText">  Several times a week</span><br>
        <input type="radio" name="in3" value="4"><span class="questionText">  Once a week</span><br>
        <input type="radio" name="in3" value="3"><span class="questionText">  Several times a month</span><br>
        <input type="radio" name="in3" value="2"><span class="questionText"> Once a month</span><br>
        <input type="radio" name="in3" value="1"><span class="questionText">  Never</span><br>
      </form>
      </form>
      <form id="ins4user">
        <span class="slideText">Check out other's profiles without leaving comments.</span><br><br>
        <input type="radio" name="in4" value="10"><span class="questionText">  All the time</span><br>
        <input type="radio" name="in4" value="9"><span class="questionText">  Several times an hour</span><br>
        <input type="radio" name="in4" value="8"><span class="questionText">  Once an hour</span><br>
        <input type="radio" name="in4" value="7"><span class="questionText"> Several times a day</span><br>
        <input type="radio" name="in4" value="6"><span class="questionText">  Once a day</span><br>
        <input type="radio" name="in4" value="5"><span class="questionText">  Several times a week</span><br>
        <input type="radio" name="in4" value="4"><span class="questionText">  Once a week</span><br>
        <input type="radio" name="in4" value="3"><span class="questionText">  Several times a month</span><br>
        <input type="radio" name="in4" value="2"><span class="questionText"> Once a month</span><br>
        <input type="radio" name="in4" value="1"><span class="questionText">  Never</span><br>
      </form>
      </form>
    </div>
    ...
    <div class="input-group" id="insta5" method="get">
      ...
      <form id="ins5user" >
        ...
        <input type="radio" name="in5" value="10"><span class="questionText">  All the time</span><br>
        <input type="radio" name="in5" value="9"><span class="questionText">  Several times an hour</span><br>
        <input type="radio" name="in5" value="8"><span class="questionText">  Once an hour</span><br>
        <input type="radio" name="in5" value="7"><span class="questionText"> Several times a day</span><br>
        <input type="radio" name="in5" value="6"><span class="questionText">  Once a day</span><br>
        <input type="radio" name="in5" value="5"><span class="questionText">  Several times a week</span><br>
        <input type="radio" name="in5" value="4"><span class="questionText">  Once a week</span><br>
        <input type="radio" name="in5" value="3"><span class="questionText">  Several times a month</span><br>
        <input type="radio" name="in5" value="2"><span class="questionText"> Once a month</span><br>
        <input type="radio" name="in5" value="1"><span class="questionText">  Never</span><br>
      </form>
      </form>
      <form id="ins6user">
        <span class="slideText">Post something that is not directed to specific people.</span><br><br>
        <input type="radio" name="in6" value="10"><span class="questionText">  All the time</span><br>
        <input type="radio" name="in6" value="9"><span class="questionText">  Several times an hour</span><br>
        <input type="radio" name="in6" value="8"><span class="questionText">  Once an hour</span><br>
        <input type="radio" name="in6" value="7"><span class="questionText"> Several times a day</span><br>
        <input type="radio" name="in6" value="6"><span class="questionText">  Once a day</span><br>
        <input type="radio" name="in6" value="5"><span class="questionText">  Several times a week</span><br>
        <input type="radio" name="in6" value="4"><span class="questionText">  Once a week</span><br>
        <input type="radio" name="in6" value="3"><span class="questionText">  Several times a month</span><br>
        <input type="radio" name="in6" value="2"><span class="questionText"> Once a month</span><br>
        <input type="radio" name="in6" value="1"><span class="questionText">  Never</span><br>
      </form>
      </form>
    </div>
